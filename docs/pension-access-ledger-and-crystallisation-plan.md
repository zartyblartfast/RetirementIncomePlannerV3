...
- Explicit taxable FAD events and ordinary ledger-aware FAD withdrawals now have regression coverage confirming they deplete the same crystallised drawdown pool and do not emit the old compatibility mixed-mode warning.
